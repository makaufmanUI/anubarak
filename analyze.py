...
class Analysis:
    ...
    Properties
    ----------
    - `anubarak_dps_lost`  --  The DPS lost on Anub'arak by directing focus to Nerubian Burrowers.
    - `burrower_dps_added`  --  The DPS gained on Nerubian Burrowers by directing focus away from Anub'arak.
    - `dps_done`  --  Information about DPS done:
        - `raid1`  --  The DPS the raid as a whole did to Anub'arak in phase 3, in the original `t₀` time span.
        - `raid2`  --  The DPS the raid as a whole did to Anub'arak in phase 3, in the new `t₀ + Δt` time span, after reallocation of damage.
        - `raid_pct_change`  --  The percentage change in raid DPS to Anub'arak between the original raid DPS and the raid DPS after reallocation of damage.
    - `dps_taken`  --  Information about DPS taken (DTPS):
        - `main_tank`  --  ...
        - `off_tanks`  --  ...
        - `raid`  --  ...
        - `raid_LS`  --  ...
        - `raid_PC`  --  ...
        - `total`  --  ...
    - `hps_taken`  --  Information about HPS taken (HTPS):
        - `anubarak`  --  ...
        - `raid`  --  ...
        - `total`  --  ...
